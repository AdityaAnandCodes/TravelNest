...
const Destinations = () => {
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div id="destinations" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-8 p-8">
        {destinations.map((destination, index) => (
          <Link key={index} to={`/destinations/${destination.id}`}> {/* Add Link component */}
            <DestinationCard
